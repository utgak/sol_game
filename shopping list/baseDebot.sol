...
abstract contract SLBaseDebot is Debot, Upgradable {
    bytes m_icon;

    TvmCell m_ShoppingListCode;
    TvmCell m_ShoppingListData;
    address internal m_address;  // shopping list contract address
    uint256 internal m_masterPubKey; // User pubkey
    address internal m_msigAddress;  // User wallet address
    ...
    function setShoppingListCode(TvmCell code, TvmCell data) public {
        ...
        m_ShoppingListInit = tvm.buildStateInit(m_ShoppingListCode, m_ShoppingListData);
    }
    ...
    function getDebotInfo() public functionID(0xDEB) override view returns(
        ...
        version = "0.2.0";
        publisher = "TON Labs";
        key = "Shopping list list manager";
        author = "TON Labs";
    ...
    function deploy() private view {
            ...
            TvmCell deployMsg = tvm.buildExtMsg({
                ...
                pubkey: none,
                stateInit: image,
                call: {ISLConstructor, m_masterPubKey}
            });
